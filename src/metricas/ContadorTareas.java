...
public class ContadorTareas extends Metrica {
	...
	public ContadorTareas() {
		descripcion = new Descripcion("Proceso de orientación", "ContadorTareas",
				"Muestra el número de tareas, normalizada sobre el número total de cambios.",
				"¿Cuál es el volumen medio de trabajo de las tareas?",
				"CT = NT (Numero de tareas) / NTC (Numero total de cambios)", "CT >= 0 mejor valores intermedios",
