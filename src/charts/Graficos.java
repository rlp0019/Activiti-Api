...
public class Graficos {
	/**
	 * Genera un componente ChartPanel que contiene un gráfico de barras con las
	...
	public static ChartPanel crearGraficoBarra3d(Conjunto valores, String titulo, String tituloX, String tituloY) {
		...
		JFreeChart chart = ChartFactory.createBarChart3D(titulo, tituloX, tituloY, data, PlotOrientation.VERTICAL,
				false, true, false);
	...
	/**
	 * Genera un componente ChartPanel qu contien un grñafico de tarta con las
	 * características proporcionadas.
	 * 
